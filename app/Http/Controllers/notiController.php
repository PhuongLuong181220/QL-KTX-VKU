   ...
   public function save_noti(Request $request){
    ...
    public function update_noti(Request $request, $noti_id){
        ...
        if($get_image){
            ...
            Session::put('message','Đã cập nhật thông báo');
            return Redirect::to('all-noti');
        }
    ...
    public function edit_baocao($id){
        
        $edit_baocao = DB::table('baocao')->where('id',$id)->get();

        return view('admin.edit_baocao')->with('edit_baocao',$edit_baocao);
    }
    public function update_baocao(Request $request,$id){
        ...
        DB::table('baocao')->where('id',$id)->update($data);
        Session::put('message','Đã cập nhật tình trạng');
        return Redirect::to('all-baocao');
    }
    public function delete_baocao($id){
        
        DB::table('baocao')->where('id',$id)->delete();
